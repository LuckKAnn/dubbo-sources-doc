...
public class DubboProtocol extends AbstractProtocol {
    ...
    public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
        ...
        //存储本JVM导出的服务，key包括了端口，服务path，服务版本
        ...
        // 开启NettyServer
        openServer(url);
        //请求--->invocation--->服务key--->exporterMap.get(key)--->exporter--->invoker--->
        // invoker.invoke(invocation)-->执行服务
        //invocation对象封装了请求的参数信息
    ...
    private ExchangeClient[] getClients(URL url) {
        ...
        // 消费者应用引用了两个服务A和B，这两个服务都部署在了应用C上，如果connections为2，
        // 那么消费者应用会与应用C建立4个Socket连接
        // connections代表的是对于一个服务建立多少个连接
        //shareConnectionsStr代表的是对于一个应用建立多少个共享连接
        ...
        // 消费者应用引用了两个服务A和B，这两个服务都部署在了应用C上，如果shareConnectionsStr为2，
